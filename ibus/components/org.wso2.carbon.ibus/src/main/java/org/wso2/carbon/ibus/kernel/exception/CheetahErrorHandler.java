...
package org.wso2.carbon.ibus.kernel.exception;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.wso2.carbon.ibus.kernel.flow.FlowControllerCallback;
 ...
 */
public class CheetahErrorHandler implements FaultHandler {

    private Logger logger = LoggerFactory.getLogger(CheetahErrorHandler.class);
    ...
    public CheetahErrorHandler(String name, MediatorCollection mediatorCollection) {
        this.name = name;
