 ...
 * under the License.
 */
package org.wso2.carbon.ibus.kernel.config.dsl.external.wuml;


import org.wso2.carbon.ibus.kernel.config.dsl.external.StringParserUtil;
import org.wso2.carbon.ibus.kernel.config.dsl.external.WUMLConfigurationBuilder;
import org.wso2.carbon.ibus.kernel.config.dsl.external.flow.MediatorFactory;
import org.wso2.carbon.ibus.kernel.config.dsl.external.inbound.InboundEndpointFactory;
import org.wso2.carbon.ibus.kernel.config.dsl.external.inbound.InboundEndpointType;
import org.wso2.carbon.ibus.kernel.config.dsl.external.outbound.OutboundEndpointFactory;
import org.wso2.carbon.ibus.kernel.config.dsl.external.outbound.OutboundEndpointType;
import org.wso2.carbon.ibus.kernel.flow.Mediator;
import org.wso2.carbon.ibus.kernel.flow.Pipeline;
import org.wso2.carbon.ibus.kernel.flow.mediators.builtin.FlowControllers.filter.Condition;
...
import org.wso2.carbon.ibus.kernel.inbound.builtin.http.HTTPInboundEP;
