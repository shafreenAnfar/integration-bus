...
package org.wso2.carbon.esb5.mediation.cheetah.outbound.protocol.http.builder;
...
public class HTTPOutboundEPBuilder {
    ...
    public static HTTPOutboundEPBuilder httpOutboundEndpoint(String name, URI uri) {
