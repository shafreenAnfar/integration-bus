 ...
 * under the License.
 */
package org.wso2.carbon.esb5.mediation.cheetah.inbound.protocols.http;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.wso2.carbon.esb5.mediation.cheetah.config.CheetahConfigRegistry;
import org.wso2.carbon.esb5.mediation.cheetah.config.ConfigRegistryObserver;
...
public class HTTPInboundEPDispatcher implements Dispatcher, ConfigRegistryObserver {
    ...
    public boolean dispatch(CarbonMessage cMsg, CarbonCallback callback) {
        ...
        int port = 9090; // TODO: Get the port from cMsg
